    ...
    <section class="card">
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-items-details" class="pt-2">
                ...
                <form class="form form-horizontal" method="post" action="{{ url('admin/invoice/'.$dataPermohonan->id) }}" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-md-3 label-control">Invoice</label>
                            <div class="col-md-9 mx-auto">
                                <label id="invoice" class="file center-block">
