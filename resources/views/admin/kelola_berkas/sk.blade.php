...
<div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title">Unggah SKHP</h3>
    <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Unggah SKHP
                </li>
            </ol>
        </div>
    </div>
    ...
    <section class="card">
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-items-details" class="pt-2">
                ...
                <form class="form form-horizontal" method="post" action="{{ url('admin/sk/'.$dataPermohonan->id) }}" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-md-3 label-control" for="input1">Batas Masa Berlaku</label>
                            <div class="col-md-9 mx-auto">
                                <input type="date" id="input1" class="form-control @error('masa_berlaku') is-invalid @enderror" name="masa_berlaku" value="{{ old('masa_berlaku') }}">
                                <small class="text-danger"> {{ $errors->first('masa_berlaku') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 label-control">Unggah SKHP</label>
                            <div class="col-md-9 mx-auto">
                                <label id="file_sk" class="file center-block">
                                    <input type="file" name="file_sk" id="file_sk">
                                    <span class="file-custom"></span>
                                </label>
                                <small class="text-danger"> {{ $errors->first('file_sk') }}</small>
                            </div>
                        </div> 
