@extends('layouts.app')
@section('title','Detail Permohonan Masuk')
@section('css_section')
    <!-- BEGIN: Vendor CSS-->
            ...
            <div id="invoice-items-details" class="pt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12" style="text-align: center">
                        <a href="{{ url('admin/tolak-permohonan-masuk/'.$dataPermohonan->id) }}"><button type="submit" class="btn btn-danger"><i class="la la-close"></i> Tolak</button></a>
                        <a href="{{ url('admin/verifikasi-permohonan-masuk/'.$dataPermohonan->id) }}"><button type="submit" class="btn btn-success"><i class="la la-check"></i> Verifikasi</button></a>
                    </div>
                </div>
                @endif
            </div>
