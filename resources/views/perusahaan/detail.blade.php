    ...
    <section class="card">
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-items-details" class="pt-2">
                ...
                @if ($dataPermohonan->invoice != NULL && $dataPermohonan->bukti_bayar == NULL)
                <form class="form form-horizontal" method="post" action="{{ url('bukti_bayar/'.$dataPermohonan->id) }}" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-md-3 label-control">Unggah Bukti Bayar</label>
                            <div class="col-md-9 mx-auto">
                                <label id="bukti_bayar" class="file center-block">
