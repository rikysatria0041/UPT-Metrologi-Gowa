    ...
    <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Riwayat Permohonan {{ $page_tittle ?? '' }}
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Riwayat Data Permohonan Tera/Tera Ulang <strong>{{ $page_tittle ?? '' }}</strong></h4>
