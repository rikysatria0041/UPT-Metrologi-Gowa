    ...
    <section class="card">
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-items-details" class="pt-2">
                ...
                @if ($dataPermohonan->status == 'ACC ADMIN')
                <div class="row" style="background-color: blue ">
                    <div class="col-md-7 col-sm-12 text-center text-md-left">
                    </div>
                    <div class="col-md-5 col-sm-12" style="text-align: center">
                        <form action="{{ url('superadmin/permohonan-masuk/'.$dataPermohonan->id.'/verifikasi') }}" method="POST" class="d-inline">
                            @method('patch')
                            @csrf
                            <button type="submit" class="btn btn-success"><i class="la la-check"></i> Verifikasi</button>
                        </form>
                    </div>
                </div>
                @endif
